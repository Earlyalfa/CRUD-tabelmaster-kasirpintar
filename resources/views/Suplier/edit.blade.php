    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('suplier.update', $suplier->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama" value="{{ $suplier->nama }}" required>
            </div>
            <div class="mb-3">
                <label for="alamat" class="form-label">Alamat</label>
                <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $suplier->alamat }}" required>
            </div>
            <div class="mb-3">
